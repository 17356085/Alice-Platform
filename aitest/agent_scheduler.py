...
用法:
  python -m aitest.agent_scheduler check --module=tank        # 检查前置条件
  python -m aitest.agent_scheduler next --module=tank         # 推荐下一步 Agent
  python -m aitest.agent_scheduler auto --module=tank         # 自动推进到下一步
"""
import os
