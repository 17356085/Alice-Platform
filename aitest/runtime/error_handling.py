...
# [LAYER:Runtime/ErrorHandling] 从 aitest/infra/error_logger.py 搬入
...
def log_error(
    ...
    try:
        ...
        import sys
        logger.error(f"[aitest.infra.error_logger FATAL] Cannot write to {ERROR_LOG}: {log_msg}", file=sys.stderr)
