...
用法:
    from aitest.prompt_benchmark import PromptBenchmark
...
class PromptBenchmark:
    ...
    def compare(
        ...
        from aitest.evaluator import EvalRunner, LLMJudge, CompositeJudge
        from aitest.regression import _section_similarity
