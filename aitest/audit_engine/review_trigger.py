...
Usage:
  python -m aitest.audit_engine.review_trigger           # 检查并排队
  python -m aitest.audit_engine.review_trigger --dry-run # 仅报告，不排队
  python -m aitest.audit_engine.review_trigger --list    # 查看当前队列
  python -m aitest.audit_engine.review_trigger --clear   # 清空队列
"""
