...
六维检查:
  P-Check: Phase Sequence 合规性
  S-Check: Skip Audit (跳过的 Phase 是否有原因记录)
...
用法:
    from aitest.sop_auditor import SOPAuditor, run_sop_audit
...
class SOPAuditor:
    ...
    def audit(self, module: str, days: int = 7,
        ...
        if checks is None:
            checks = ["p_check", "s_check", "g_check", "h_check", "b_check", "l_check", "x_check"]
