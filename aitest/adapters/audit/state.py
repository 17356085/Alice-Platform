# [LAYER:Adapter/Audit] 从 aitest/audit_engine/state_auditor.py 搬入
"""
...
TODO (file split, ~20h): Extract 7 check methods into audit_engine/checks/:
  checks/structure_check.py    — _run_s_check (62L)
  checks/requirements_check.py — _run_r_check (57L)
  checks/output_check.py       — _run_o_check + _check_output_consistency (77L)
  checks/orphan_check.py       — _run_orphan_check (28L)
  checks/coverage_check.py     — _run_c_check + _check_cross_page_coverage (136L)
  checks/quality_check.py      — _run_q_check + _check_file_quality (68L)
  checks/tech_check.py         — _run_t_check (73L)
  checks/bsc_check.py          — _run_bsc_check + _compute_bsc_score (190L)
  state_auditor.py             — orchestrator: audit(), _summarize_check, _attempt_repairs, _write_report

Each check is independently testable. Shared state (module dir, pages, report) via clean interface.
...
用法:
    ...
    logger.info(report["overall_status"], report["drifts"])
