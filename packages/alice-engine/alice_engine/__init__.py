...
_LAZY_EXPORTS = {
    ...
    "RuntimeArtifactRecord": ("alice_engine.runtime_contracts", "RuntimeArtifactRecord"),
    "RuntimeCheckpointRecord": ("alice_engine.runtime_contracts", "RuntimeCheckpointRecord"),
    "RuntimeReplaySessionRecord": ("alice_engine.runtime_contracts", "RuntimeReplaySessionRecord"),
    "RuntimeReplayStepRecord": ("alice_engine.runtime_contracts", "RuntimeReplayStepRecord"),
    "RuntimeEventEnvelope": ("alice_engine.runtime_contracts", "RuntimeEventEnvelope"),
    # Capability contracts
    "CapabilityContract": ("alice_engine.capabilities", "CapabilityContract"),
    "CapabilityProvider": ("alice_engine.capabilities", "CapabilityProvider"),
    "CapabilityToolCall": ("alice_engine.capabilities", "CapabilityToolCall"),
    "CapabilityToolDef": ("alice_engine.capabilities", "CapabilityToolDef"),
    "CapabilityToolResult": ("alice_engine.capabilities", "CapabilityToolResult"),
    "capability_contract": ("alice_engine.capabilities", "capability_contract"),
