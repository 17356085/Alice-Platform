...
class DeepSeekProvider(LLMProvider):
    ...
    provider_description = "DeepSeek OpenAI-compatible API provider"
    ...
    def complete(
        ...
        **kwargs,
        ...
        # ★ Reasoning models (DeepSeek-v4, o1, etc.) may return empty content with reasoning_content
    ...
    def stream(
        ...
        **kwargs,
        ...
        if self.client is None:
            yield StreamEvent(type="error", error_message="DEEPSEEK_API_KEY 未设置")
            return LLMResponse(content="DEEPSEEK_API_KEY 未设置", model=self.model, finish_reason="error")
        ...
        try:
            ...
            logger.error("DeepSeek API streaming error: %s", e)
