# /execution-agent — 执行 Agent (v2.0)
> 本文件已精简。完整 Agent 定义（含 SOP 门禁、核心能力、执行策略、失败路由）见 `.claude/skills/execution-agent/SKILL.md`。
...
|-------|-------|--------|--------|
| execution-agent | 4.5~7 | 1 (execution/allure-report-analyzer) | agent-definitions.yaml |
