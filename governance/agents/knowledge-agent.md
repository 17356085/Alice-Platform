# /knowledge-agent — 知识 Agent (v2.0)
> 本文件已精简。完整 Agent 定义（含 SOP 门禁、核心能力、沉淀标准、去重规则、边界）见 `.claude/skills/knowledge-agent/SKILL.md`。
...
|-------|-------|--------|--------|
| knowledge-agent | 横向贯穿 | 1 (knowledge/knowledge-manager) | agent-definitions.yaml |
