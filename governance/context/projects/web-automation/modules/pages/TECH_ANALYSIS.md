我来执行 `automation/tech-analysis` 任务。首先，我需要了解当前项目的结构，特别是模块和页面信息。
...
<｜｜DSML｜｜invoke name="bash">
<｜｜DSML｜｜parameter name="description" string="true">扫描页面上下文目录</｜｜DSML｜｜parameter>
<｜｜DSML｜｜parameter name="command" string="true">ls governance/context/projects/web-automation/modules/pages/ 2>/dev/null || echo "pages 目录不存在"</｜｜DSML｜｜parameter>
</｜｜DSML｜｜invoke>
</｜｜DSML｜｜tool_calls>